                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-12 col-lg-8">
                                                ...
                                                <div className="row p-2">
                                                    ...
                                                    <div className="col-7">
                                                        <div className="radio-inputs w-75">
                                                    ...
                                                    <table className="table table-borderd bg-white">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>01.</td>
                                                                <td>Piragash</td>
                                                                <td>piragash@gmail.com</td>
                                                                <td>0770454544</td>
                                                                <td>Customer</td>
                                                                <td className='text-center'>
                                                                    <span className="booking-status completed">Available</span>
                                ...
                                <div class="modal-body bg-gray">
                                    <form>
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-sm-10">
                                                <select className='form-control' name='from_location'>
                                                    <option value="">-- Select Location --</option>
                                                    <option value="">Jaffna</option>
                                                    <option value="">Vavuniya</option>
                                                    <option value="">Kilinochi</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-sm-10">
                                                <select className='form-control' name='to_location'>
                                                    <option value="">-- Select Location --</option>
                                                    <option value="">Jaffna</option>
                                                    <option value="">Vavuniya</option>
                                                    <option value="">Kilinochi</option>
